...
*[![simple-scan](https://snapcraft.io/simple-scan/badge.svg)](https://snapcraft.io/simple-scan)
[![simple-scan](https://snapcraft.io/simple-scan/trending.svg?name=0)](https://snapcraft.io/simple-scan)*
...
git remote add ubuntu https://github.com/ubuntu/simple-scan.git
git fetch --all
```
